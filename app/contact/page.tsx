        ...
        <div className="py-20">
            <Container>
                <div className="max-w-3xl mx-auto text-center mb-16">
                    <h1 className="text-4xl font-bold tracking-tight sm:text-5xl mb-6 font-serif text-slate-900">Contactez-nous</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                    ...
                    <div className="bg-card p-6 text-center rounded-2xl shadow-sm border">
                        ...
                        <p className="text-muted-foreground">bonjour@cabinetdentaire.com</p>
